          ...
          return (
            ...
            >
              <div className="flex items-center">
                ...
                <div className="w-24 h-48 flex-shrink-0 bg-gradient-to-b from-wine-dark/50 to-wine-darker/50 flex items-center justify-center p-3 relative overflow-hidden">
