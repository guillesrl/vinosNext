      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {currentWines.map((wine, index) => {
          ...
          return (
            <div
              key={wine.id || index}
              className="bg-wine-dark/80 border border-cork-400/20 rounded-lg overflow-hidden hover:shadow-lg transition-all duration-300 hover:border-cork-400/40 backdrop-blur-sm text-sm group h-64"
            >
